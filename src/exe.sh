...
# Evaluate config
python3 evaluate.py -c config/config_to_train/Adam_OCS_batch16_1e-5à1e-2.json
...
python3 history.py -p data/pickles/history/history_data/saved_weights/new_weights/new_file_RMSprop_OCS_sansCB_batchsize32_bestLoss.h5.p

# Multi training
sh multi_train.sh config/config_to_train/config_list.txt
