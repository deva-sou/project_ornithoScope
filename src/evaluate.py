...
argparser.add_argument(
    '-c',
    '--conf',
    default='config/config_to_train/lr_fixé_newcap.json', #à changer selon les config
...
argparser.add_argument(
    '-w',
    '--weights',
    default='data/saved_weights/new_weights/lr_fixé_newcap300_bestLoss.h5', #à changer selon les config
